...
> [WireHummingbirdDesign.md](WireHummingbirdDesign.md), Tier 2 in
...
What replaced them is the **contribution-alias** contract (M2, [AdapterModel.md](AdapterModel.md)):
...
The survey behind that shape is in [WireHummingbirdDesign.md](WireHummingbirdDesign.md): every
...
3. **How tightly does WireMVC integrate with WireOpenAPI?** Much more tightly than "parallel adapter
   ...
   routing model, not two — see [WireOpenAPIAdvanced.md](WireOpenAPIAdvanced.md).
...
- [WireHummingbirdDesign.md](WireHummingbirdDesign.md) — Tier 1's settled model, and the
