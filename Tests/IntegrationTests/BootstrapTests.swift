...
struct BootstrapTests {
    ...
    @Test func testContainerProducesWiredGraphFromOwnBindings() async throws {
        ...
        //   - `Wire.bootstrapTestContainer()` resolves
    ...
    @Test func defaultGraphAndTestContainerAreIndependent() async throws {
        ...
        let defaultGraph = try await Wire.bootstrap()
        let testGraph = try await Wire.bootstrapTestContainer()
    ...
    @Test func seedScopeBootstrapInjectsSeedAndBorrowsSingleton() async throws {
        // The generated `Wire.bootstrapTestRequestSeedScope(seed:wireGraph:)`
    ...
    @Test func scopeBlockProvidesResolveWithinSeedScope() async throws {
        ...
        let graph = try await Wire.bootstrap()
        let scope = try await Wire.bootstrapOrderSeedScope(
    ...
    @Test func containerScopeBootstrapBorrowsFromContainerWireGraph() async throws {
        ...
        // `Wire.bootstrapTestContainer_TestJobSeedScope(seed:testContainerWireGraph:)`
        ...
        let containerGraph = try await Wire.bootstrapTestContainer()
        let scope = try await Wire.bootstrapTestContainer_TestJobSeedScope(
    ...
    @Test func seedScopeEntriesProduceDistinctInstances() async throws {
        ...
        let scopeB = try await Wire.bootstrapTestRequestSeedScope(
    ...
    @Test func containerMultibindingAggregatesContainerContributors() async throws {
        ...
        let graph = try await Wire.bootstrapPluginContainer()
    ...
    @Test func seedScopeMultibindingAggregatesScopeContributors() async throws {
        ...
        let graph = try await Wire.bootstrap()
        let scope = try await Wire.bootstrapReportSeedScope(
    ...
    @Test func moduleScopeKeyContributedPerContainer() async throws {
        ...
        let prod = try await Wire.bootstrapProdContainer()
        #expect(prod.serviceHost.services.map { $0.name() } == ["real"])

        let test = try await Wire.bootstrapTestEnvContainer()
    ...
    @Test func containerPartitionsPickTheirOwnContributions() async throws {
        ...
        let containerGraph = try await Wire.bootstrapWidgetContainer()
        #expect(containerGraph.singletonView.render() == ["singleton"])

        let scope = try await Wire.bootstrapWidgetContainer_WidgetSeedScope(
