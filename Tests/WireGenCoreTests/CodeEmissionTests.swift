...
struct CodeEmissionTests {
    ...
    @Test func singleContainerEmitsItsOwnStructAlongsideEmptyDefault() {
        ...
        let expected = """
            ...
            internal struct _TestContainerWireGraph: Introspectable, Teardownable {
                let logger: Logger
    ...
    @Test func multipleContainersAreEmittedInSortedOrder() {
        ...
        let expected = """
            ...
            internal struct _AlphaWireGraph: Introspectable, Teardownable {
                let a: A
            ...
            internal struct _BravoWireGraph: Introspectable, Teardownable {
                let b: B
    ...
    @Test func opaqueBindingsLiftGenericParametersOntoWireGraph() {
        ...
        let expected = """
            ...
            internal struct _WireGraph<T0: DBTable & Sendable, T1: TaskRepo, T2: API>: Introspectable, Teardownable {
    ...
    @Test func structuralLiftNodeReusesBridgeTargetParameterAsNestedField() {
        ...
        let expected = """
            ...
            internal struct _WireGraph<T0: DBTable & Sendable, T1: TaskRepo>: Introspectable, Teardownable {
                let someDBTableSendable: T0
                let someTaskRepo: T1
    ...
    @Test func multiParamStructuralLiftNodeSubstitutesEachParameterIndependently() {
        ...
        let expected = """
            ...
            internal struct _WireGraph<T0: TaskRepo, T1: Logger>: Introspectable, Teardownable {
                let someTaskRepo: T0
                let someLogger: T1
